...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        testIntegers(new CompletedTwoProbeChainHT<>());
        testStrings(new CompletedTwoProbeChainHT<>());

        System.out.println("GeneralProbingHT: ");
        testIntegers(new CompletedLinearProbingHT<>());
        testStrings(new CompletedLinearProbingHT<>());
    ...
    public static void testStrings(SymbolTable<String, Integer> st) {
        ...
        assert(!st.isEmpty())           : "symbol table is empty after inserting elements";
